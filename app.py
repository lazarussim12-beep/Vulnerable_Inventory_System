...
app = Flask(__name__)
app.secret_key = "hardcoded_inventory_secret_987"  # VULNERABILITY: hard-coded secret
app.config["DEBUG"] = True  # VULNERABILITY: debug mode enabled in prod
app.config["UPLOAD_FOLDER"] = "uploads"
app.config["JWT_SECRET"] = "inventory_jwt"  # VULNERABILITY: weak JWT secret
